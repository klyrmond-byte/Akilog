...
child: FilterChip(label: Text(c), selected: _catSelecionada,
...
trailing: const Icon(Icons.arrow_forward_ios, size: 16), onTap: ()=>Navigator.push(context, MaterialPageRoute(builder: (context) => TelaRastreio(compra: c))),
));
}),
);
}
